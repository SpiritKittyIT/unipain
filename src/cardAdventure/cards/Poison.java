...
import cardAdventure.statusEffects.Poisoned;
import cardAdventure.statusEffects.StatusEffect;

/**
* Class to represent status effect cards that give the Poisoned StatusEffect to the user.
* extends Card.
*/
public class Poison extends Card {
    ...
    /**
    * Constructor for Poison class members.
    * @param name the name of the card
    * @param description the cards describtion
    * @param stacks number of stacks for the Poisoned StatusEffect that the card grants
    */
    ...
    * Any <b>{s}</b> in the describtion is replaced by the number of stacks for the Poisoned StatusEffect that the card grants.
