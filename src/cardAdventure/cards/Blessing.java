...
import cardAdventure.statusEffects.Blessed;
import cardAdventure.statusEffects.StatusEffect;

/**
* Class to represent status effect cards that give the Blessed StatusEffect to the user.
* extends Card.
*/
public class Blessing extends Card {
    ...
    /**
    * Constructor for Blessing class members.
    * @param name the name of the card
    * @param description the cards describtion
    * @param stacks number of stacks for the Blessed StatusEffect that the card grants
    */
    ...
    * Any <b>{s}</b> in the describtion is replaced by the number of stacks for the Blessed StatusEffect that the card grants.
